...
{
    private static Color royalBlue = new Color(0.3f, 0.5f, 0.9f, 1.0f);
    private static Color skyBlue = new Color(0.2f, 0.8f, 1.0f, 1.0f);
    private static Color yellow = new Color(1.0f, 1.0f, 0.4f, 1.0f);
    private static Color orange = new Color(1.0f, 0.6f, 0.2f, 1.0f);
    private static Color purple = new Color(0.7f, 0.3f, 0.9f, 1.0f);
    private static Color green = new Color(0.2f, 0.7f, 0.3f, 1.0f);
    private static Color gray = new Color(0.6f, 0.6f, 0.6f, 1.0f);
    private static Color pink = new Color(1.0f, 0.4f, 0.7f, 1.0f);
    private static Color red = new Color(1.0f, 0.3f, 0.3f, 1.0f);
